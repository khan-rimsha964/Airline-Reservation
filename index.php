    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="docs/assets/img/pak1.jpg" alt="First slide">
          <div class="container">
            <div class="carousel-caption">
              <h1 style="color:Black;">PAK FLY</h1>
              <p style="color:Black;">The No. 1 Travel site in Pakistan</p>
              <p><a class="btn btn-lg btn-primary" href="register_form.html" role="button">Sign up today</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img class="second-slide" src="docs/assets/img/pak3.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
              <h1 style="color:Blue;">PAK FLY</h1>
              <p style="color:Blue;">Plan your journey here. Leave Everything to us.</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">Learn more</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img class="third-slide" src="docs/assets/img/pak2.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>PAK FLY</h1>
